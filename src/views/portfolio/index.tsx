...
function Portfolio() {
  ...
  return (
    <div className="flex flex-col items-center w-full h-full">
      <div id="focus_point" className="mobile:w-full h-full sm:p-0 desktop:w-1/2">
        <Header
        ...
        />
        <div className="flex flex-col <sm:-mt-24 -mt-8 justify-center m-2 space-y-4 desktop:mx-0 sm:mt-2">
